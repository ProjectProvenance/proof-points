...
- Web3js dependency has been replaced by ethersjs dependency. The constructor of `ProofPointRegistry` has changed to accept an `ethers.providers.JsonRpcProvider` instead of a `Web3` instance.
